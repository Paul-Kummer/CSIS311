...
<body>
<?php
$dbname = "paul-kummer_CLIMBING"; // replace with your database name
$username = "paul-kummer";  // replace with your username
$password = "0lW9td9Vv";  // replace with your password, nobody can see it
extract($_POST);
echo <<< HERE
   <form method="POST"> 
   <h2>Database: $dbname</h2>
   <h2>View Tables: 
         <input type="submit" name="button" value="ROUTE">
   </h2>
   </form>
